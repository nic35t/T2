...
export const ProfileScreen: React.FC<ProfileScreenProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="bg-background min-h-screen text-white font-display pb-28">
      <header className="flex-none pt-12 pb-4 px-6 flex items-center justify-center relative z-10 border-b border-white/5">
        <h1 className="text-lg font-bold tracking-tight font-serif">Profile</h1>
        <div 
      ...
      <main className="flex-1 overflow-y-auto no-scrollbar pb-6">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-gray-500">Check tickets & history</p>
              </div>
            </div>
        ...
        <div className="px-4 flex flex-col gap-6">
          <div>
            <h3 className="px-2 mb-2 text-[10px] font-bold text-gray-500 uppercase tracking-widest">Account</h3>
            <div className="bg-surface-card rounded-2xl overflow-hidden shadow-sm border border-white/5">
              {[
                { icon: 'badge', label: 'Personal Info' },
                { icon: 'lock', label: 'Password & Security' },
                { icon: 'devices', label: 'Linked Devices', sub: 'iPhone 14 Pro, iPad Air' }
              ].map((item, idx) => (
          ...
          <div className="pb-8 text-center">
            <p className="text-[10px] text-gray-600 font-mono">L.TICKET v2.4.0 (Build 20231024)</p>
          </div>
        </div>
      </main>
    </div>
